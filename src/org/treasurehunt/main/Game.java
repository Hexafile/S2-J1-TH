...
public class Game {
	public static void main(String[] args) {
		...
		b.getBoard()[2][2].setCharacter(new Explorer(0, 0, 0));

		
		for(int i = 0; i<l.get(0);i++){
			b.getBoard()[b.getBase(1)][0].setCharacter(new Explorer(0, 0, 0));
		}
		
		for(int i = 0; i<l.get(0);i++){
			b.getBoard()[b.getBase(2)][b.getSizeWidth()-1].setCharacter(new Explorer(0, 0, 0));
		}
